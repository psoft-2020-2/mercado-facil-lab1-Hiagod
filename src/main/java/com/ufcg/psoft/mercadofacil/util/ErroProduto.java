...
public class ErroProduto {
	...
	public static ResponseEntity<CustomErrorType> erroSemDescricaoCadastrada() {
		return new ResponseEntity<CustomErrorType>(new CustomErrorType(ErroProduto.PRODUTOS_SEM_DESCRICAO),
				HttpStatus.NO_CONTENT);
		}
	}
